<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="e_Business" Title="Welcome to Distibuted data mining" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: left; height: 415px;">
        <table style="width: 993px; position: static; height: 751px">
            <tr>
                <td align="left" style="width: 100px" valign="top">
                    <asp:Panel ID="Panel1" runat="server" Height="50px" Style="position: static" Width="494px">
                        <p class="MsoNormal" 
                            
                            
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 81px; width: 980px;">
                            <span style="color: black; mso-bidi-font-family: 'TimesNewRoman,Bold'; mso-bidi-font-weight: bold; ">
                                 </span>
                        </p>
                        <p align="center" class="MsoNormal" 
                            
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 1635px; width: 1009px; background-image: url('ads/background.JPG');">
                            &nbsp;</p>
                        <p class="MsoNormal" 
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 409px; width: 870px;">
                            &nbsp;</p>
                        <p class="MsoNormal" 
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 409px; width: 870px;">
                            &nbsp;</p>
                        <p class="MsoNormal" 
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 409px; width: 870px;">
                            <span style="color: black; mso-bidi-font-family: 'TimesNewRoman,Bold'; mso-bidi-font-weight: bold; background-image: url('ads/background.JPG');">
                            &nbsp; </span>
                        </p>
                        <p class="MsoNormal" 
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 145px; width: 591px;">
                            &nbsp;</p>
                        <p class="MsoNormal" 
                            style="margin: 0in 0in 0pt; mso-layout-grid-align: none; height: 145px; width: 591px;">
                            &nbsp;</p>
